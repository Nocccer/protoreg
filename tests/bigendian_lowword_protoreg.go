...
func (m BigEndianLowWord) Marshal() ([]uint16, error) {
	...
	// Uint32Array[0]
	buf[59] = uint16(m.Uint32Array[0])
	buf[60] = uint16(m.Uint32Array[0] >> 16)
	// Uint32Array[1]
	buf[63] = uint16(m.Uint32Array[1])
	buf[64] = uint16(m.Uint32Array[1] >> 16)
	// Uint32Array[2]
	buf[67] = uint16(m.Uint32Array[2])
	buf[68] = uint16(m.Uint32Array[2] >> 16)
	// Uint32Array[3]
	buf[71] = uint16(m.Uint32Array[3])
	buf[72] = uint16(m.Uint32Array[3] >> 16)
	// Uint32Array[4]
	buf[75] = uint16(m.Uint32Array[4])
	buf[76] = uint16(m.Uint32Array[4] >> 16)
	// Float32Array[0]
	tmp32 = math.Float32bits(float32(m.Float32Array[0]))
	buf[79] = uint16(tmp32)
	buf[80] = uint16(tmp32 >> 16)
	// Float32Array[1]
	tmp32 = math.Float32bits(float32(m.Float32Array[1]))
	buf[81] = uint16(tmp32)
	buf[82] = uint16(tmp32 >> 16)
	// Float32Array[2]
	tmp32 = math.Float32bits(float32(m.Float32Array[2]))
	buf[83] = uint16(tmp32)
	buf[84] = uint16(tmp32 >> 16)
	// Float32Array[3]
	tmp32 = math.Float32bits(float32(m.Float32Array[3]))
	buf[85] = uint16(tmp32)
	buf[86] = uint16(tmp32 >> 16)
	// Float32Array[4]
	tmp32 = math.Float32bits(float32(m.Float32Array[4]))
	buf[87] = uint16(tmp32)
	buf[88] = uint16(tmp32 >> 16)
	// BoolArray[0]
	...
	for i := 0; i < len(m.StringASCII32); i++ {
		...
		buf[96+i*2] = uint16(tmp32)
		buf[96+i*2+1] = uint16(tmp32 >> 16)
	}
	// StringUTF832
	i = 0
	for _, r := range m.StringUTF832 {
		if i >= 2 {break}
		tmp32 = uint32(r)
		buf[100+i*2] = uint16(tmp32)
		buf[100+i*2+1] = uint16(tmp32 >> 16)
		i++
	}
...
func (m *BigEndianLowWord) Unmarshal(buf []uint16) error {
	...
	// Uint32Array[0]
	m.Uint32Array[0] = uint32(buf[59]) | uint32(buf[60]) << 16
	// Uint32Array[1]
	m.Uint32Array[1] = uint32(buf[63]) | uint32(buf[64]) << 16
	// Uint32Array[2]
	m.Uint32Array[2] = uint32(buf[67]) | uint32(buf[68]) << 16
	// Uint32Array[3]
	m.Uint32Array[3] = uint32(buf[71]) | uint32(buf[72]) << 16
	// Uint32Array[4]
	m.Uint32Array[4] = uint32(buf[75]) | uint32(buf[76]) << 16
	// Float32Array[0]
	tmp32 = uint32(buf[79]) | uint32(buf[80]) << 16
	m.Float32Array[0] = math.Float32frombits(tmp32)
	// Float32Array[1]
	tmp32 = uint32(buf[81]) | uint32(buf[82]) << 16
	m.Float32Array[1] = math.Float32frombits(tmp32)
	// Float32Array[2]
	tmp32 = uint32(buf[83]) | uint32(buf[84]) << 16
	m.Float32Array[2] = math.Float32frombits(tmp32)
	// Float32Array[3]
	tmp32 = uint32(buf[85]) | uint32(buf[86]) << 16
	m.Float32Array[3] = math.Float32frombits(tmp32)
	// Float32Array[4]
	tmp32 = uint32(buf[87]) | uint32(buf[88]) << 16
...
func (m *BigEndianLowWordAllCustom) Unmarshal(buf []uint16) error {
	...
	// Uint32Array[0]
	m.Uint32Array[0] = CustomUint32(buf[59]) | CustomUint32(buf[60]) << 16
	// Uint32Array[1]
	m.Uint32Array[1] = CustomUint32(buf[63]) | CustomUint32(buf[64]) << 16
	// Uint32Array[2]
	m.Uint32Array[2] = CustomUint32(buf[67]) | CustomUint32(buf[68]) << 16
	// Uint32Array[3]
	m.Uint32Array[3] = CustomUint32(buf[71]) | CustomUint32(buf[72]) << 16
	// Uint32Array[4]
	m.Uint32Array[4] = CustomUint32(buf[75]) | CustomUint32(buf[76]) << 16
	// Float32Array[0]
	tmp32 = uint32(buf[79]) | uint32(buf[80]) << 16
...
func (m *BigEndianLowWordAllCustomExtern) Unmarshal(buf []uint16) error {
	...
	// Uint32Array[0]
	m.Uint32Array[0] = extern.CustomUint32(buf[59]) | extern.CustomUint32(buf[60]) << 16
	// Uint32Array[1]
	m.Uint32Array[1] = extern.CustomUint32(buf[63]) | extern.CustomUint32(buf[64]) << 16
	// Uint32Array[2]
	m.Uint32Array[2] = extern.CustomUint32(buf[67]) | extern.CustomUint32(buf[68]) << 16
	// Uint32Array[3]
	m.Uint32Array[3] = extern.CustomUint32(buf[71]) | extern.CustomUint32(buf[72]) << 16
	// Uint32Array[4]
	m.Uint32Array[4] = extern.CustomUint32(buf[75]) | extern.CustomUint32(buf[76]) << 16
	// Float32Array[0]
	tmp32 = uint32(buf[79]) | uint32(buf[80]) << 16
